...
import { StarSystem, Planet, ResourceType } from '../types/galaxy';
...
export function StarSystemView({ system, width, height, onBack, onBuildingCreated, onBuyBuilding, onCanBuyBuilding }: StarSystemViewProps) {
    ...
    if (selectedPlanet) {
        return (
            <PlanetView
                ...
                onCanBuyBuilding={onCanBuyBuilding}
            />
        );
    }
